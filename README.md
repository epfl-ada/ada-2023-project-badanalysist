...
## Abstract
This project delves into beer popularity and user taste preferences using datasets from BeerAdvocate and RateBeer. With a focus on understanding beer popularity, naming influence, and style similarities, the study employs methods like k-means clustering, sentiment analysis, and graph network modeling. Analyzing 732,000 BeerAdvocate and 542,000 RateBeer ratings, the study explores regional preferences, sentiment in beer names, textual similarities between styles, and builds personalized recommendation systems. Combining statistical methods with NLP techniques, the project aims to guide breweries and tailor recommendations, considering not only popularity but also quality attributes and regional differences in beer preferences.
